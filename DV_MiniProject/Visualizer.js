...
function createBars(ds) {
    ...
    gradient.append("stop")
        .attr("offset", "33%")
        .attr("stop-color", "#d18fd9")
        .attr("stop-opacity", 1);

    gradient.append("stop")
        .attr("offset", "75%")
        .attr("stop-color", "#4c2a86")
        .attr("stop-opacity", 1);

    gradient.append("stop")
        .attr("offset", "100%")
        .attr("stop-color", "#cb997e")
        .attr("stop-opacity", 1);
...
d3.csv("/data/plagues.csv").then(function(data) {
    ...
    let colorRange = [-90, -75, -45, -25, -8, -5, 0]; 
